...
<form className="space-y-4" onSubmit={(e) => { e.preventDefault(); handleGenerateBook(); }}>
              ...
              <Input name="subtitle" label="Sugestão de Subtítulo" value={formData.subtitle} onChange={handleInputChange} placeholder="Ex: Estratégias para alavancar seu negócio online" />
